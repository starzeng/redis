 ...
 *
 */
public class ObjectHashMapper2 {
	 ...
	 */
	public static Object fromHash(Map<String, String> map) throws IntrospectionException, IllegalAccessException,
			InstantiationException, InvocationTargetException, ClassNotFoundException {
		if (map == null || map.isEmpty()) {
			return null;
		}
		String _class = new String(map.get("_class"));
